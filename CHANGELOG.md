...
## [v5.3.0](../../tree/unstable) - UNRELEASED
- In `DeviceSpy`:
  - Added: CalcCountryFromIP() - softly internal, this API should be treated as volatile and may change sans major version increment.
